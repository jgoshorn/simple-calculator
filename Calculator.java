...
public class Calculator implements ActionListener
{
    ...
    private void initGUI()
    {
        ...
        //set property of input text field
        /*
         *
         * */
        ...
        *
        * */
        GridLayout deleteButtonsLayout = new GridLayout(1, 2);
        deleteButtonsLayout.setHgap(GAP);
        deleteButtonsLayout.setVgap(GAP);
        JPanel deleteButtonsPanel = new JPanel(deleteButtonsLayout); //contains "delete" buttons
        ...
        * */
        ...
        deleteButtonsPanel.add(btnBack);
        ...
        * */
        ...
        deleteButtonsPanel.add(btnClear);

        topPanel.add(deleteButtonsPanel); //put "backspace" and "clear" buttons on delete button panel
        ...
        buttonsLayout.setHgap(GAP);
        buttonsLayout.setVgap(GAP);
        JPanel buttonsPanel = new JPanel(buttonsLayout); //contains number AND operation buttons
        ...
        {
            numbers[i] = new JButton(buttonValues[i]);
    ...
    private void configureButton(JButton button)
    {
        ...
        button.setForeground(Color.ORANGE); //text color
    ...
    //resets current total, holding variables, operation, and text field display
    private void reset() {
        logic.reset();
        temp1 = 0.0;
        temp2 = 0.0;
        currentOp = "";
        text = "0"; //reset text field display
        inputText.setText(text);
    }
